 ...
 * @method Results save(array $data, boolean $waitForRefresh = TRUE)
 * @method array insertBulk(array $data, bool $returnData = false, boolean $waitForRefresh = TRUE)
 * @method Results multipleAggregate(array $functions, array $wheres, array $options, string $column)
 * @method Results deleteAll(array $wheres, array $options = [], bool $waitForRefresh = TRUE)
