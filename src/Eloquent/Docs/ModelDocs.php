 ...
 * @method static $this searchFor($value, $fields = ['*'], $settings = [], $boolean = 'and')
 * @method static $this searchTerm($term, $fields = ['*'], $settings = [], $boolean = 'and')
 * @method static $this searchTermMost($term, $fields = ['*'], $settings = [], $boolean = 'and')
 * @method static $this searchTermCross($term, $fields = ['*'], $settings = [], $boolean = 'and')
 * @method static $this searchPhrase($phrase, $fields = ['*'], $settings = [], $boolean = 'and')
 * @method static $this searchPhrasePrefix($phrase, $fields = ['*'], $settings = [], $boolean = 'and')
 * @method static $this searchBoolPrefix($phrase, $fields = ['*'], $settings = [], $boolean = 'and')
 * @method static $this orSearchFor($value, $fields = ['*'], $settings = [])
 * @method static $this orSearchTerm($term, $fields = ['*'], $settings = [])
 * @method static $this orSearchTermMost($term, $fields = ['*'], $settings = [])
 * @method static $this orSearchTermCross($term, $fields = ['*'], $settings = [])
 * @method static $this orSearchPhrase($phrase, $fields = ['*'], $settings = [])
 * @method static $this orSearchPhrasePrefix($phrase, $fields = ['*'], $settings = [])
 * @method static $this orSearchBoolPrefix($phrase, $fields = ['*'], $settings = [])
 *
